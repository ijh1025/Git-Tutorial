...
<body>
  ...
  <div class="container">
  <form action="boardReply.do" method="post" enctype="multipart/form-data">
 ...
 <tr>
  ...
  <td>
  <textarea class="form-control" rows="10" name="boardContent" maxlength="2048" placeholder="글내용을 입력하세요"></textarea>
  </td>
  </tr> 
  <tr>
 ...
 <input type="text" class="form-control input-lg" disabled placeholder="파일 업로드하세요.">
