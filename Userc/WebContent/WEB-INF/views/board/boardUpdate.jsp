...
<body>
  ...
  <td style="width: 110px"><h5>아이디</h5></td>
   <td><h5>${board.userID}</h5>
   <input type="hidden" name="userID" value="<%=userID %>">
   <input type="hidden" name="boardID" value="${board.boardID}"></td>
  </tr>
  <tr>
  <td style="width: 110px"><h5>글 제목</h5></td>
  <td><input class="form-control" type="text" maxlength="50" name="boardTitle" placeholder="글제목을 입력하세요"
  value="${board.boardTitle}"></td>
  </tr>
 <tr>
  <td style="width: 110px"><h5>글 내용</h5></td>
  <td>
  <textarea class="form-control" rows="10" name="boardContent" maxlength="2048" placeholder="글내용을 입력하세요">${board.boardContent}</textarea>
  </td>
  </tr> 
  <tr>
 ...
 <input type="text" class="form-control input-lg" disabled placeholder="${board.boardFile}">
 <span class="input-group-btn">
 <button class="browse btn btn-primary input-lg" type="button">
 <i class="glyphicon glyphicon-search">파일찾기</i>
 </button>
 </span>
 </div>
  </td>
